...
import behaviours.CustomerAgentRegisterBehaviour;
...
public class CustomerAgent extends Agent 
{
	...
	protected void subscribe() 
	{
		...
		sd.setType("BuildingCS");
		sd.setName("BuildingCS");
		DFAgentDescription template = new DFAgentDescription();
		template.addServices(sd);	
		addBehaviour(new CustomerAgentRegisterBehaviour(template, this, 1000));
	}
