 ...
 */
public class BuildingCSAgentSubscrInitiator extends SubscriptionInitiator 
{
	private static final long serialVersionUID = 2596974171933664345L;
	protected BuildingCSAgent subscriber;
	private String FORMAT = "yyyy-MM-dd hh:mm:ss";
	private SimpleDateFormat sdf = new SimpleDateFormat(FORMAT);

	public BuildingCSAgentSubscrInitiator(BuildingCSAgent a, ACLMessage msg) 
	{
		super(a, msg);
		this.subscriber = a;	
	}
	...
	{ 
		try 
		{
			...
			{	
				...
				//
				this.subscriber.setPowerConsumption(inform.getSender(), smsg.getMessage().getValue());
			}
