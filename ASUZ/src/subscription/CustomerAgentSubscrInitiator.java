 ...
 */
public class CustomerAgentSubscrInitiator extends SubscriptionInitiator 
{
	private static final long serialVersionUID = 2596974171933664345L;
	protected CustomerAgent subscriber;
	private String FORMAT = "yyyy-MM-dd hh:mm:ss";
	private SimpleDateFormat sdf = new SimpleDateFormat(FORMAT);

	public CustomerAgentSubscrInitiator(CustomerAgent a, ACLMessage msg) 
	{
		super(a, msg);
		this.subscriber = a;	
	}
