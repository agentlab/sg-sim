 ...
 */
public class BuildingCSAgentSubscrManager implements SubscriptionManager 
{
	private Vector<Subscriber> subscribers = new Vector<Subscriber>(); 		// Subscriber list
	protected BuildingCSAgent buildingcs;
	private BuildingCSAgentSendingBehaviour tick_behavior = new BuildingCSAgentSendingBehaviour(buildingcs, 1000, this); 

	public BuildingCSAgentSubscrManager(BuildingCSAgent c) 
	{
		this.buildingcs = c;
	}
