...
import behaviours.BuildingAgentFindCustomersBehaviour;
 ...
 * 
 */
public class CountryHouse extends Agent 
{
	private static final long serialVersionUID = 3731134492500110874L;
	//
	public String name = "Building";		// Agent's name on yellow page service
	public String type = "Building";		// Agent's type on yellow page service
	//
	private SubscriptionResponder dfSubscriptionResponder;
	private BuildingAgentSubscrManager subManager;
	//
	...
	protected void subscribeCustomers() 
	{
		...
		addBehaviour(new BuildingAgentFindCustomersBehaviour(template, this, 10000));
	}
	...
	private void createSubscrManager()
	{
		...
		this.subManager = new BuildingAgentSubscrManager(this);
