 ...
 */
public class NRJStationSubscrInitiator extends SubscriptionInitiator 
{
	private static final long serialVersionUID = 2596974171933664345L;
	protected NRJStationAgent subscriber;
	private String FORMAT = "yyyy-MM-dd hh:mm:ss";
	private SimpleDateFormat sdf = new SimpleDateFormat(FORMAT);

	public NRJStationSubscrInitiator(NRJStationAgent a, ACLMessage msg) 
	{
		super(a, msg);
		this.subscriber = a;	
	}
	...
	{ 
		...
		System.out.println("Agent " + 
						   this.subscriber.getAID().getName() + 
						   " received the INFORM from agent " + 
