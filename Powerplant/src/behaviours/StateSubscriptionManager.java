...
public class StateSubscriptionManager implements SubscriptionManager {
	...
	protected sg_sim.PowerplantAgent myAgent;
	protected PowerplantBehaviour powerplant;
	 ...
	 * @param agent
	 */
	public StateSubscriptionManager(PowerplantAgent agent) {
		myAgent = agent;
	...
	public boolean register(Subscription sub) throws RefuseException, NotUnderstoodException {
		...
		if(subscriptions.size() == 1)
			myAgent.addBehaviour(new PowerplantStateNotificationBehaviour(myAgent, this));
		return true;
	}
	...
	public void setPowerplant(PowerplantBehaviour wt) {
		this.powerplant = wt;
	}
	
	public PowerplantBehaviour powerplant() {
