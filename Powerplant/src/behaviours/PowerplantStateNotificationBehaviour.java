...
public class PowerplantStateNotificationBehaviour extends TickerBehaviour {
	private static final long serialVersionUID = 5144767620080730711L;

	protected StateSubscriptionManager subManager;
	
	public PowerplantStateNotificationBehaviour(Agent a, StateSubscriptionManager subManager) {
		super(a, 5000);
