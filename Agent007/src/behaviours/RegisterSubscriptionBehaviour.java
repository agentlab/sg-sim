 ...
 * 
 */
public class RegisterSubscriptionBehaviour extends TickerBehaviour {
	 ...
	 */
	public RegisterSubscriptionBehaviour(DFAgentDescription template, Agent a, long period) {
		super(a, period);
	...
	protected void onTick() {
		...
		try {
			...
			if (result.length > 0) {
				...
				myAgent.addBehaviour(new SubscrInitiatorBehaviour((ControlAgent)myAgent, subscribe));
