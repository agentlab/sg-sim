...
public class StateSubscriptionManager implements SubscriptionManager {
	...
	protected sg_sim.NuclearBlock myAgent;
	protected NuclearPowerPlantAgentBehaviour windTurbine;
	 ...
	 * @param agent
	 */
	public StateSubscriptionManager(NuclearBlock agent) {
		myAgent = agent;
	...
	public boolean register(Subscription sub) throws RefuseException, NotUnderstoodException {
		...
		if(subscriptions.size() == 1)
			myAgent.addBehaviour(new NuclearAgentStateNotificationBehaviour(myAgent, this));
		return true;
	}
	...
	public void setWindTurbine(NuclearPowerPlantAgentBehaviour wt) {
		this.windTurbine = wt;
	}
	
	public NuclearPowerPlantAgentBehaviour windTurbine() {
