...
public class StupidModel1AdapterFactory implements IAdapterFactory {
	...
	public Object getAdapter(Object agent, Class type) {
		if (type == IColorProvider.class) {
			...
			if (agent instanceof Scape
				...
				return org.metaabm.examples.stupid1.BugStyle2DColorProvider
						.getDefault();
			}

			if (agent instanceof Scape
					&& ((Scape) agent).getPrototypeAgent().getClass() == Habitat.class) {
				return org.metaabm.examples.stupid1.HabitatStyle2DColorProvider
						.getDefault();
			}
		...
		if (type == IFigureProvider.class) {
			...
			if (agent instanceof Scape
					&& ((Scape) agent).getPrototypeAgent().getClass() == Bug.class) {
				return org.metaabm.examples.stupid1.BugStyle2DFigureProvider
						.getDefault();
			}

			if (agent instanceof Scape
					&& ((Scape) agent).getPrototypeAgent().getClass() == Habitat.class) {
				return org.metaabm.examples.stupid1.HabitatStyle2DFigureProvider
						.getDefault();
			}
