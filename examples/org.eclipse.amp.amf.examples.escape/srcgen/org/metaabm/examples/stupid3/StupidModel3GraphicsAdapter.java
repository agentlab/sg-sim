 ...
 * @generated
 */
public class StupidModel3GraphicsAdapter extends GraphicsAdapter {
	...
	IColorProvider[] stupidModel3ColorProviders = new IColorProvider[]{};
	...
	IFigureProvider[] stupidModel3FigureProviders = new IFigureProvider[]{};
	...
	public IColorProvider[] getColorsForClass(Class type) {
		if (type == StupidModel3.class) {
			return stupidModel3ColorProviders;
		}
		if (type == Bug.class) {
	...
	public IFigureProvider[] getFiguresForClass(Class type) {
		if (type == StupidModel3.class) {
			return stupidModel3FigureProviders;
		}
		if (type == Bug.class) {
	...
	public static IGraphicsAdapter getDefault() {
		if (singleton == null) {
			singleton = new StupidModel3GraphicsAdapter();
		}
		return singleton;
	}
}
