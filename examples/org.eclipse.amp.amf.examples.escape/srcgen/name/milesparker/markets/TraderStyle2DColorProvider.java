 ...
 * @generated
 */
public class TraderStyle2DColorProvider implements IColorProvider {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a color for Trader based on wether we want to fill or not.
	 * 
	...
	public Color getColor(Object object, boolean fill) {
		...
		Trader actions = (Trader) object;
		Trader traderRule = actions;
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a foreground color for the given Trader.
	 * 
	 * @param object the agent
	 * @return	the foreground color for the element, or <code>null</code> 
	 *   to use the default foreground color
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a background color for the given Trader.
	 * 
	 * @param object the agent
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new TraderStyle2DColorProvider();
		}
		return singleton;
	}
}
