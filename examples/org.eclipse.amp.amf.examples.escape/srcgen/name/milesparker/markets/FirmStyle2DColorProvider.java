 ...
 * @generated
 */
public class FirmStyle2DColorProvider implements IColorProvider {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a color for Firm based on wether we want to fill or not.
	 * 
	...
	public Color getColor(Object object, boolean fill) {
		...
		Firm actions = (Firm) object;
		Firm firmRule = actions;
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a foreground color for the given Firm.
	 * 
	 * @param object the agent
	 * @return	the foreground color for the element, or <code>null</code> 
	 *   to use the default foreground color
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a background color for the given Firm.
	 * 
	 * @param object the agent
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new FirmStyle2DColorProvider();
		}
		return singleton;
	}
}
