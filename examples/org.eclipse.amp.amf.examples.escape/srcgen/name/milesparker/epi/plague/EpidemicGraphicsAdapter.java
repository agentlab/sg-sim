...
public class EpidemicGraphicsAdapter extends GraphicsAdapter {
	...
	IColorProvider[] individualColorProviders = new IColorProvider[]{IndividualStyle2DColorProvider
			.getDefault()};
	IColorProvider[] fleaColorProviders = new IColorProvider[]{FleaStyle2DColorProvider
			.getDefault()};
	IColorProvider[] ratColorProviders = new IColorProvider[]{RatStyle2DColorProvider
			.getDefault()};
	...
	IFigureProvider[] individualFigureProviders = new IFigureProvider[]{IndividualStyle2DFigureProvider
			.getDefault()};
	IFigureProvider[] fleaFigureProviders = new IFigureProvider[]{FleaStyle2DFigureProvider
			.getDefault()};
	IFigureProvider[] ratFigureProviders = new IFigureProvider[]{RatStyle2DFigureProvider
			.getDefault()};
	...
	public IColorProvider[] getColorsForClass(Class type) {
		...
		if (type == Flea.class) {
			return fleaColorProviders;
		}
		if (type == Rat.class) {
			return ratColorProviders;
		}
		return null;
	}
	...
	public IFigureProvider[] getFiguresForClass(Class type) {
		...
		if (type == Flea.class) {
			return fleaFigureProviders;
		}
		if (type == Rat.class) {
			return ratFigureProviders;
		}
		return null;
	}
