 ...
 * @generated
 */
public class RatStyle2DColorProvider implements IColorProvider {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a color for Rat based on wether we want to fill or not.
	 * 
	...
	public Color getColor(Object object, boolean fill) {
		...
		Rat actions = (Rat) object;
		Rat ratRule = actions;
		outlineColor = ColorConstants.orange;
		if (fill) {
			return fillColor;
		} else {
			return outlineColor;
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a foreground color for the given Rat.
	 * 
	 * @param object the agent
	 * @return	the foreground color for the element, or <code>null</code> 
	 *   to use the default foreground color
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a background color for the given Rat.
	 * 
	 * @param object the agent
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new RatStyle2DColorProvider();
		}
		return singleton;
	}
}
