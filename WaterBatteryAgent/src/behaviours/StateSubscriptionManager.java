...
import agents.WaterBatteryAgent;
...
public class StateSubscriptionManager implements SubscriptionManager {
	...
	protected agents.WaterBatteryAgent myAgent;
	protected WaterBatteryBehaviour Waterbattery;
	 ...
	 * @param agent
	 */
	public StateSubscriptionManager(WaterBatteryAgent agent) {
		myAgent = agent;
	...
	public boolean register(Subscription sub) throws RefuseException, NotUnderstoodException {
		...
		if(subscriptions.size() == 1)
			myAgent.addBehaviour(new WaterBatteryStateNotificationBehaviour(myAgent, this));
		return true;
	}
	...
	public void setPowerplant(WaterBatteryBehaviour wt) {
		this.Waterbattery = wt;
	}
	
	public WaterBatteryBehaviour powerplant() {
		return this.Waterbattery;
	}
}