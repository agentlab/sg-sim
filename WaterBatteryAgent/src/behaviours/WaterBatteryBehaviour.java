...
public class WaterBatteryBehaviour extends TickerBehaviour {
	...
	public WaterBatteryBehaviour(Agent a, int Mass, double heat, double eff2, double eff1, StateSubscriptionManager subManager, SubscriptionResponder dfSubscriptionResp) {
		super(a, 5000);
		this.spheat=heat;
		...
		try {
			...
			myAgent.addBehaviour(new WaterBatteryRequestResponderBehaviour(this, this.myAgent, template));        
	...
	public double max_power_calc ()
	{
		...
		return this.waterMass*0.278*this.spheat*this.efficiency1*this.efficiency2;
	}
