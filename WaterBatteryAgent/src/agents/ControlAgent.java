...
public class ControlAgent extends Agent {
	...
	private Ontology ontology = WaterBatteryOntology.getInstance(); //создание экземпл€ров классов онтологии и €зыка
	...
	public void setup() { 
		...
		//ищем через сервис желтых страниц агентов
		...
		for (DFAgentDescription agent : agents) {
			...
			if(agentID.getLocalName().compareTo("WaterBattery") != 0) continue;
			...
			BeginWaterTransitionRequest bptr = new BeginWaterTransitionRequest();
