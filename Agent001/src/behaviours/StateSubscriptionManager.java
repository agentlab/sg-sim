...
import agents.GeoTermTurbAgent;
...
public class StateSubscriptionManager implements SubscriptionManager {
	...
	protected agents.GeoTermTurbAgent myAgent;
	protected GeoTermTurbBehaviour GeoTermTurbine;
	 ...
	 * @param agent
	 */
	public StateSubscriptionManager(GeoTermTurbAgent agent) {
		myAgent = agent;
	...
	public boolean register(Subscription sub) throws RefuseException, NotUnderstoodException {
		...
		if(subscriptions.size() == 1)
			myAgent.addBehaviour(new GeoTermTurbineStateNotificationBehaviour(myAgent, this));
		return true;
	}
	...
	public void setGeoTermTurbine(GeoTermTurbBehaviour wt) {
		this.GeoTermTurbine = wt;
	}
	
	public GeoTermTurbBehaviour GeoTermTurbine() {
		return this.GeoTermTurbine;
	}
}