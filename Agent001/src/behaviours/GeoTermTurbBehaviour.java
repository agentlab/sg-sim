...
public class GeoTermTurbBehaviour extends TickerBehaviour {
	...
	public GeoTermTurbBehaviour(Agent a, int GeoTermsp, double airdens, int leng, double blim, StateSubscriptionManager subManager, SubscriptionResponder dfSubscriptionResp) {
		super(a, 5000);
		...
		this.subManager.setGeoTermTurbine(this);
		...
		try {
			...
			myAgent.addBehaviour(new GeoTermTurbineRequestResponderBehaviour(this, this.myAgent, template));        
