...
public class PBTickerBehaviour extends TickerBehaviour {
	...
	public PBTickerBehaviour(Agent a, ACLMessage msg) {
		super(a, 3000);
	    ...
	    if (planM.getPower().length<(step+1)) this.stop();
		  ...
		  try {
		   ...
		   for (DFAgentDescription agent : agents) {
			  ...
			  if(agentID.getLocalName().compareTo("ParkTehniki") != 0) continue;
			  ...
			  step++;
			  myAgent.addBehaviour(new PBRequestInitiatorBehaviour(myAgent, aclmsg1));
		   }
		   }
	      }
	}
