...
public class ControlBehavior extends TickerBehaviour
{
	...
	public ControlBehavior(ControlSystemAgent controlsystem, long period, AID subscriptionAgent) 
	{
		super(controlsystem, period);
		...
		this.controlsystem.addBehaviour(new AchieveREInitiator(this.controlsystem, request)
								  {
										...
										protected void handleInform(ACLMessage inform)
										{
											try 
											{
												ResponceAction a = (ResponceAction) controlsystem.getContentManager().extractContent(inform);
