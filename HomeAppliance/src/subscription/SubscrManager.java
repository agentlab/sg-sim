...
import classes.*;
import behaviours.TickBehaviour;
...
public class SubscrManager implements SubscriptionManager 
{
	...
	protected ApplianceAgent appliance;
	private TickBehaviour tick_behavior = new TickBehaviour(appliance, 1000, this); 

	public SubscrManager(ApplianceAgent applianceAgent) 
	{
