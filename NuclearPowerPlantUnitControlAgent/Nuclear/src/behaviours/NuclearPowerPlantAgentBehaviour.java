...
public class NuclearPowerPlantAgentBehaviour extends TickerBehaviour {
	...
	public NuclearPowerPlantAgentBehaviour(Agent a, int windsp, double airdens, int leng, double blim, StateSubscriptionManager subManager, SubscriptionResponder dfSubscriptionResp) {
		super(a, 5000);
		...
		try {
			...
			myAgent.addBehaviour(new NuclearAgentRequestResponderBehaviour(this, this.myAgent, template));        
