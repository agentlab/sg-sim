...
import classes.*;
import behaviours.TransformatorSendingBehaviour;
 ...
 */
public class TransformatorSubscrManager implements SubscriptionManager 
{
	private Vector<Subscriber> subscribers = new Vector<Subscriber>(); 		// Subscriber list
	protected Transformator appliance;
	private TransformatorSendingBehaviour tick_behavior = new TransformatorSendingBehaviour(appliance, 1000, this); 

	public TransformatorSubscrManager(Transformator applianceAgent) 
	{
