 ...
 */
public class NakopitelSubscrInitiator extends SubscriptionInitiator 
{
	private static final long serialVersionUID = 2596974171933664345L;
	protected NakopitelEE subscriber;
	private String FORMAT = "yyyy-MM-dd hh:mm:ss";
	private SimpleDateFormat sdf = new SimpleDateFormat(FORMAT);

	public NakopitelSubscrInitiator(NakopitelEE a, ACLMessage msg) 
	{
		super(a, msg);
		this.subscriber = a;	
	}
