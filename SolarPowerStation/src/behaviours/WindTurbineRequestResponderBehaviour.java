...
public class WindTurbineRequestResponderBehaviour extends AchieveREResponder {
	private static final long serialVersionUID = 1L;

	private WindTurbBehaviour windTurbine;

	public WindTurbineRequestResponderBehaviour(WindTurbBehaviour wt, Agent a, MessageTemplate mt) {
		super(a, mt);
		windTurbine = wt;
	}
