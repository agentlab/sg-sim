 ...
 * Conditioner class
 */
public abstract class BasePlantAgent extends Agent 
{
	...
	public abstract void controlAppliance(SetMachineCount ca);
								   ...
								   try 
									{
										...
										{	
											...
											if (ca instanceof SetMachineCount)
											{
												controlAppliance((SetMachineCount)ca);
												//
											...
											else if (ca instanceof TryToControl)
											{
