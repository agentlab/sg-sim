...
import agents.BasePlantAgent;
import classes.*;
import behaviours.SendingBehaviour;
...
public class SubscrManager implements SubscriptionManager 
{
	...
	protected BasePlantAgent appliance;
	private SendingBehaviour tick_behavior = new SendingBehaviour(appliance, 1000, this); 

	public SubscrManager(BasePlantAgent applianceAgent) 
	{
